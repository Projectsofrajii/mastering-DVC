...
class RsmMeterMaster(models.Model):
    meter_id = models.CharField(primary_key=True, max_length=45)
    meter_serial_number = models.CharField(max_length=45, blank=True, null=True)

class InstantModel(models.Model):
    auto_index = models.AutoField(primary_key=True)
    meter_id = models.ForeignKey(RsmMeterMaster,on_delete=models.CASCADE,related_name='Instant')
